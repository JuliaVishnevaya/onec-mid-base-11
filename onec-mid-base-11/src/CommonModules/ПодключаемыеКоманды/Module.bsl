...
Процедура ПриСозданииНаСервере(Форма, Знач ПараметрыРазмещения = Неопределено) Экспорт
	...
	// {{ ДЗ2_ДоработкаТиповыхКонфигураций. Дополнение формы. 

	ДорабКЛ_ДополнитьФорму(форма)
...
Процедура ДорабКЛ_ДополнитьФорму(Форма) Экспорт
	
	ДорабКЛ_ДоработкаФормыДокумента.ДополнитьФорму(Форма); 
